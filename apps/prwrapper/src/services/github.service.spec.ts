...
import { fetchData } from '../../../../libs/common/services';
...
describe('GithubService', () => {
  ...
  it('should get all pull requests', async () => {
    const mockResponse = [
      {
        url: 'https://api.github.com/repos/redbonzai/prwrapper/pulls/7',
        id: 1971873187,
        node_id: 'PR_kwDOMShu6851iGWj',
        html_url: 'https://github.com/redbonzai/prwrapper/pull/7',
        diff_url: 'https://github.com/redbonzai/prwrapper/pull/7.diff',
        patch_url: 'https://github.com/redbonzai/prwrapper/pull/7.patch',
        issue_url: 'https://api.github.com/repos/redbonzai/prwrapper/issues/7',
        number: 7,
        state: 'open',
        locked: false,
        title: 'Dockerize',
        ...
        milestone: null,
        draft: false,
        commits_url: 'https://api.github.com/repos/redbonzai/prwrapper/pulls/7/commits',
        review_comments_url: 'https://api.github.com/repos/redbonzai/prwrapper/pulls/7/comments',
        review_comment_url:
          'https://api.github.com/repos/redbonzai/prwrapper/pulls/comments{/number}',
        comments_url: 'https://api.github.com/repos/redbonzai/prwrapper/issues/7/comments',
        statuses_url:
          'https://api.github.com/repos/redbonzai/prwrapper/statuses/fefccbe51d829e04426c765bf93dfd2590e5796e',
        head: {
          ...
          repo: {
            ...
            html_url: 'https://github.com/redbonzai/prwrapper',
            description: null,
            fork: false,
            url: 'https://api.github.com/repos/redbonzai/prwrapper',
            forks_url: 'https://api.github.com/repos/redbonzai/prwrapper/forks',
            keys_url: 'https://api.github.com/repos/redbonzai/prwrapper/keys{/key_id}',
            collaborators_url:
              'https://api.github.com/repos/redbonzai/prwrapper/collaborators{/collaborator}',
            teams_url: 'https://api.github.com/repos/redbonzai/prwrapper/teams',
            hooks_url: 'https://api.github.com/repos/redbonzai/prwrapper/hooks',
            issue_events_url:
              'https://api.github.com/repos/redbonzai/prwrapper/issues/events{/number}',
            events_url: 'https://api.github.com/repos/redbonzai/prwrapper/events',
            assignees_url: 'https://api.github.com/repos/redbonzai/prwrapper/assignees{/user}',
            branches_url: 'https://api.github.com/repos/redbonzai/prwrapper/branches{/branch}',
            tags_url: 'https://api.github.com/repos/redbonzai/prwrapper/tags',
            blobs_url: 'https://api.github.com/repos/redbonzai/prwrapper/git/blobs{/sha}',
            git_tags_url: 'https://api.github.com/repos/redbonzai/prwrapper/git/tags{/sha}',
            git_refs_url: 'https://api.github.com/repos/redbonzai/prwrapper/git/refs{/sha}',
            trees_url: 'https://api.github.com/repos/redbonzai/prwrapper/git/trees{/sha}',
            statuses_url: 'https://api.github.com/repos/redbonzai/prwrapper/statuses/{sha}',
            languages_url: 'https://api.github.com/repos/redbonzai/prwrapper/languages',
            stargazers_url: 'https://api.github.com/repos/redbonzai/prwrapper/stargazers',
            contributors_url: 'https://api.github.com/repos/redbonzai/prwrapper/contributors',
            subscribers_url: 'https://api.github.com/repos/redbonzai/prwrapper/subscribers',
            subscription_url: 'https://api.github.com/repos/redbonzai/prwrapper/subscription',
            commits_url: 'https://api.github.com/repos/redbonzai/prwrapper/commits{/sha}',
            git_commits_url: 'https://api.github.com/repos/redbonzai/prwrapper/git/commits{/sha}',
            comments_url: 'https://api.github.com/repos/redbonzai/prwrapper/comments{/number}',
            issue_comment_url:
              'https://api.github.com/repos/redbonzai/prwrapper/issues/comments{/number}',
            contents_url: 'https://api.github.com/repos/redbonzai/prwrapper/contents/{+path}',
            compare_url: 'https://api.github.com/repos/redbonzai/prwrapper/compare/{base}...{head}',
            merges_url: 'https://api.github.com/repos/redbonzai/prwrapper/merges',
            archive_url: 'https://api.github.com/repos/redbonzai/prwrapper/{archive_format}{/ref}',
            downloads_url: 'https://api.github.com/repos/redbonzai/prwrapper/downloads',
            issues_url: 'https://api.github.com/repos/redbonzai/prwrapper/issues{/number}',
            pulls_url: 'https://api.github.com/repos/redbonzai/prwrapper/pulls{/number}',
            milestones_url: 'https://api.github.com/repos/redbonzai/prwrapper/milestones{/number}',
            notifications_url:
              'https://api.github.com/repos/redbonzai/prwrapper/notifications{?since,all,participating}',
            labels_url: 'https://api.github.com/repos/redbonzai/prwrapper/labels{/name}',
            releases_url: 'https://api.github.com/repos/redbonzai/prwrapper/releases{/id}',
            deployments_url: 'https://api.github.com/repos/redbonzai/prwrapper/deployments',
            created_at: '2024-07-05T20:08:05Z',
            updated_at: '2024-07-16T08:49:17Z',
            pushed_at: '2024-07-16T16:40:32Z',
            git_url: 'git://github.com/redbonzai/prwrapper.git',
            ssh_url: 'git@github.com:redbonzai/prwrapper.git',
            clone_url: 'https://github.com/redbonzai/prwrapper.git',
            svn_url: 'https://github.com/redbonzai/prwrapper',
            homepage: null,
            size: 456,
            stargazers_count: 0,
            watchers_count: 0,
